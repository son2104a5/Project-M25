        ...
        if (username !== '' && email !== '' && password !== '') {
            ...
            if (checkEmailResponse.data.length === 0) {
                let user: User = {
                    ...
                    avatar: "https://firebasestorage.googleapis.com/v0/b/project-m2-4c29a.appspot.com/o/admin-default.png?alt=media&token=4d0c6e77-a312-4cff-b223-afd71b2a4c1f"
                };
                try {
